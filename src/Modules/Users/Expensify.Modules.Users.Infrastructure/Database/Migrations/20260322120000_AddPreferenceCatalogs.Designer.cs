...
namespace Expensify.Modules.Users.Infrastructure.Database.Migrations
{
    ...
    [Migration("20260322120000_AddPreferenceCatalogs")]
    partial class AddPreferenceCatalogs
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Expensify.Modules.Users.Domain.Users.User", b =>
                {
                    ...
                    b.ToTable("users", "users", t =>
                        {
                            t.HasCheckConstraint("ck_users_month_start_day", "month_start_day >= 1 AND month_start_day <= 28");
                        });
                });
